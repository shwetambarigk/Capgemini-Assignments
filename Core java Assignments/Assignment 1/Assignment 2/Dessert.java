...
// for candy
 ...
 class Candy extends DessertItem {
    ...
    {
        String s = String.format(getName(), getCost()/100, weight, pricePerPound);
        return s;
    }
}
...
//Cookie
 ...
 class Cookie extends DessertItem {
    ...
    public String toString()
    {
        String s = String.format(getName(), getCost()/100, quantity, pricePerDozen);
        return s;
    }
}
...
//Icecream
 ...
 class IceCream extends DessertItem{
    ...
    public String toString()
    {
        String s = String.format(getName(), getCost()/100, numberOfScoops, pricePerScoop, toppingPrice);
        return s;
    }
}